...
//      */
//      Ellipse(const SVCG::geo_point& center, double majorRadius, double minorRadius, double course);
//
//      /*!
//      *Получить точки пересечения эллипса и линии, проходящей через точки from-to, в меркаторе
//      */
//      std::vector<SVCG::geo_point> IntersectWithLine(const colreg::geo_point& from, const colreg::geo_point& to) const;
//
//      /*!
//      *Получить точки пересечения эллипса с другим эллипсом, в меркаторе
//      */
//      std::vector<SVCG::geo_point> IntersectWithEllipse(const Ellipse& ellipse) const;
//
//      /*!
