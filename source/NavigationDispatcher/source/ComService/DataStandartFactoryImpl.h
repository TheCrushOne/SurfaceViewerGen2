...
namespace SV
{
   typedef system::ModuleGuard<data_standart::iDataStandart, central_pack*, LPCSTR, navigation_dispatcher::iComService*> StandartModuleGuard;
   ...
   typedef std::shared_ptr<DataStandartFactoryImpl> SharedDataStandartFactoryImpl;
}