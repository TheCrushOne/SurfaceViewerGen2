...
extern "C" CHARTOBJEXPRTIMPRT SV::data_standart::iDataStandart * CreateSurfaceViewerGenMapDataStandart(SV::central_pack * pack, LPCWSTR base_folder, SV::navigation_dispatcher::iComService * pService);