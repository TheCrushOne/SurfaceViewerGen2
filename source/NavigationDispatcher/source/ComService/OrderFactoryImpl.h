...
namespace SV
{
   typedef system::ModuleGuard<navigation_dispatcher::iOrder, central_pack*, navigation_dispatcher::iComService*> OrderModuleGuard;
   ...
   typedef std::shared_ptr<OrderFactoryImpl> SharedOrderFactoryImpl;
}