...
inline bool passedCheck(const std::shared_ptr<pathfinder::Matrix<bool>>& passedFlagMtx, int iRIdx, int iCIdx)
{
   if (iRIdx < 0
      || iCIdx < 0
...
inline bool inLineCheck(const std::shared_ptr<pathfinder::Matrix<bool>>& inLineFlagMtx, int iRIdx, int iCIdx)
{
   if (iRIdx < 0
      || iCIdx < 0
...
inline bool activationCheck(const std::shared_ptr<pathfinder::Matrix<bool>>& actValMtx, int iRIdx, int iCIdx)
{
   if (iRIdx < 0
      || iCIdx < 0
...
inline bool nearestActivationCheck(const std::shared_ptr<pathfinder::Matrix<bool>>& actValMtx, size_t rIdx, size_t cIdx)
{
   size_t actCount = 0;
