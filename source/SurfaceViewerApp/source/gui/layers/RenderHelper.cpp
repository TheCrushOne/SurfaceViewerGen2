...
//
//
//void RenderDomain(render::iRender* renderer, const ColregSimulation::iShip& ship, const colreg::track_point_info& center, double timeFromNow, const render::object_info& info, const colreg::domain_scales* scales)
//{
//   auto domainTopology = ship.GetDomainTopology(timeFromNow, scales);
//   if (!domainTopology)
//   {
//      return;
//   }
...
//
//   geo_points points(domainContour.size());
...
//                        , info
//                        ,{render::FIND_TYPE::FT_FIND_FAST, ship.GetInfo().id, render::FIND_OBJECT_TYPE::FOT_DOMAIN } });
//
//}
//
//
