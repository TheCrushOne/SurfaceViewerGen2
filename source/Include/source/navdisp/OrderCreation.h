...
#define PREPARE_ORDER(name) extern "C" ORDER_EXPORTIMPORT SV::navigation_dispatcher::iOrder* name(SV::central_pack* pack, SV::navigation_dispatcher::iComService* pService);
