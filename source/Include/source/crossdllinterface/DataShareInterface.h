...
namespace data_share
{
   ...
   {
      virtual void Share(const wchar_t*, const settings::map_settings&, const std::vector<std::vector<double>>&) = 0;
      virtual void GetShared(const wchar_t*, const settings::map_settings&, std::vector<std::vector<double>>&) = 0;
   };
}
