...
void XMLDatabaseController::SaveScenarioData(const settings::application_settings& settings, const std::vector<std::vector<double>>& coordGrid)
{
...
void XMLDatabaseController::LoadScenarioData(settings::application_settings& settings, std::vector<std::vector<double>>& coordGrid)
{
}
