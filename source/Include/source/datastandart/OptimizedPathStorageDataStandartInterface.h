...
extern "C" CHARTOBJEXPRTIMPRT SV::data_standart::iDataStandart * CreateOptimizedPathStorageDataStandart(SV::central_pack * pack, LPCSTR base_folder, SV::navigation_dispatcher::iComService * pService);