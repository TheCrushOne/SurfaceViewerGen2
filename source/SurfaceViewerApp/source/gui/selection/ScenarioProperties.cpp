...
void ScenarioProperties::prepareScenarioResearchSettingsFolder()
{
   ...
   CRSCENRESSTT(settings::range_data<size_t>, m_settings.res_stt.count_range, min, ScenarioResearchSettingsFieldIndex::SRSFI_COUTNRANGE_MIN);
   CRSCENRESSTT(settings::range_data<size_t>, m_settings.res_stt.count_range, max, ScenarioResearchSettingsFieldIndex::SRSFI_COUTNRANGE_MAX);
   CRSCENRESSTT(settings::range_data<size_t>, m_settings.res_stt.count_range, step, ScenarioResearchSettingsFieldIndex::SRSFI_COUTNRANGE_STEP);
